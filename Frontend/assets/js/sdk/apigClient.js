...
apigClientFactory.newClient = function (config) {
    ...
    if(config.accessKey === undefined) {
        config.accessKey = envObject.accessKey;
    }
    if(config.secretKey === undefined) {
        config.secretKey = envObject.secretKey;
    }
    if(config.apiKey === undefined) {
        config.apiKey = envObject.apiKey;
    }
    ...
    var invokeUrl = 'https://eif0bca6h8.execute-api.us-east-1.amazonaws.com/Testing';
